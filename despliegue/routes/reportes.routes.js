...
router.get("/estatus/:id", isAuth, verificarRol(ROLES_ADMIN), reportesController.getEstatusReporte);   // ← GET
router.post("/estatus/:id", isAuth, verificarRol(ROLES_ADMIN), reportesController.actualizarEstatus);   // ← POST
